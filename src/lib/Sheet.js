...
export const ABC_CLASSES = {
    ...
    'NoteheadBlack': { order: 1, access: [{ selector: '.abcjs-note[class*="abcjs-d"]:not(.abcjs-d0-5, .abcjs-d1, .abcjs-d2) > path:not([data-name*="accidental"], [data-name*="dot"], [data-name*=flag], [data-name*="scripts"], [class]), [data-name="noteheads.quarter"]' }], colors: ['#010101', '#8287FF'] },
    'NoteheadHalf': { order: 2, access: [{ selector: '.abcjs-note.abcjs-d0-5 > path:not([data-name*="accidental"], [data-name*="dot"], [data-name*="scripts"], [class])' }], colors: ['#020202', '#BDE6BF'] },
    'NoteheadWhole': { order: 3, access: [{ selector: '.abcjs-note.abcjs-d1 > path:not([data-name*="accidental"], [data-name*="dot"], [data-name*="scripts"], [class])' }], colors: ['#030303', '#2F5282'] },
    'Stem': { order: 4, access: [{ selector: '.abcjs-stem' }], colors: ['#040404', '#85A301'] },
    'Beam': { order: 5, access: [{ selector: '.abcjs-beam-elem' }], colors: ['#050505', '#6B05E8'] },
    'Brace': { order: 6, access: [{ selector: '.abcjs-brace' }], colors: ['#070707', '#8C3BFF'] },
    'Staff': { order: 7, access: [{ selector: '.abcjs-staff' }], colors: ['#080808', '#9E90AF'] },
    'LedgerLine': { order: 8, access: [{ selector: ".abcjs-ledger" }], colors: ["090909", "#018700"] },
    'BarLine': {
        order: 9,
        access: [
    ...
    'ClefF': { order: 10, access: [{ selector: '.abcjs-staff-extra > [data-name*="clefs.F"]' }], colors: ["0C0C0C", "#BCB6FF"] },
    'ClefG': { order: 11, access: [{ selector: '.abcjs-staff-extra > [data-name*="clefs.G"]' }], colors: ["0D0D0D", "#0000DD"] },
    'Sharp': { order: 12, access: [{ selector: '[data-name*="accidentals.sharp"]' }], colors: ["0E0E0E", "#C8FFF9"] },
    'Flat': { order: 13, access: [{ selector: '[data-name*="accidentals.flat"]' }], colors: ["0F0F0F", "#364426"] },
    'Natural': { order: 14, access: [{ selector: '[data-name*="accidentals.nat"]' }], colors: ["101010", "#8E8C5E"] },
    'AccidentalDoubleFlat': { order: 15, access: [{ selector: '[data-name*="accidentals.dblflat"]' }], colors: ["111111", "#BFFF8C"] },
    'AccidentalDoubleSharp': { order: 16, access: [{ selector: '[data-name*="accidentals.dblsharp"]' }], colors: ["121212", "#6ECFA7"] },
    'Flag8thUp': { order: 17, access: [{ selector: '[data-name*="flags.u8th"]' }], colors: ["131313", "#00D6D4"] },
    'Flag16thUp': { order: 18, access: [{ selector: '[data-name*="flags.u16th"]' }], colors: ["141414", "#F9FF00"] },
    'Flag32ndUp': { order: 19, access: [{ selector: '[data-name*="flags.u32nd"]' }], colors: ["151515", "#6967AF"] },
    'Flag64thUp': { order: 20, access: [{ selector: '[data-name*="flags.u64th"]' }], colors: ["161616", "#C39700"] },
    'Flag8thDown': { order: 21, access: [{ selector: '[data-name*="flags.d8th"]' }], colors: ["181818", "#DA95FF"] },
    'Flag16thDown': { order: 22, access: [{ selector: '[data-name*="flags.d16th"]' }], colors: ["191919", "#915282"] },
    'Flag32ndDown': { order: 23, access: [{ selector: '[data-name*="flags.d32nd"]' }], colors: ["1A1A1A", "#A00072"] },
    'Flag64thDown': { order: 24, access: [{ selector: '[data-name*="flags.d64th"]' }], colors: ["1B1B1B", "#569A54"] },
    'RestWhole': { order: 25, access: [{ selector: '[data-name="rests.whole"]' }], colors: ["1F1F1F", "#FFCD44"] },
    'RestHalf': { order: 26, access: [{ selector: '[data-name="rests.half"]' }], colors: ["202020", "#8201CF"] },
    'RestQuarter': { order: 27, access: [{ selector: '[data-name="rests.quarter"]' }], colors: ["212121", "#4DFDFF"] },
    'Rest8th': { order: 28, access: [{ selector: '[data-name*="rests.8th"]' }], colors: ["222222", "#89003D"] },
    'Rest16th': { order: 29, access: [{ selector: '[data-name*="rests.16th"]' }], colors: ["232323", "#7B525B"] },
    'Rest32nd': { order: 30, access: [{ selector: '[data-name*="rests.32nd"]' }], colors: ["242424", "#00749C"] },
    'Rest64th': { order: 31, access: [{ selector: '[data-name*="rests.64th"]' }], colors: ["252525", "#AA8297"] },
}
