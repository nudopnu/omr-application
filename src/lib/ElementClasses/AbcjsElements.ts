...
export const AbcjsElements: { [key in AbcjsElementType]: AbcjsElement | undefined } = {
    ...
    DynamicP: { id: 94, selector: new AspectRatioSelector('.abcjs-m0.abcjs-dynamics > path, path.abcjs-m0.abcjs-dynamics[d*="c"]', 1.119), colors: ['#000000', '#E400E2'] },
    DynamicM: { id: 95, selector: new AspectRatioSelector('.abcjs-m0.abcjs-dynamics > path, path.abcjs-m0.abcjs-dynamics[d*="c"]', 1.609), colors: ['#000000', '#B8B68A'] },
    DynamicF: { id: 96, selector: new AspectRatioSelector('.abcjs-m0.abcjs-dynamics > path, path.abcjs-m0.abcjs-dynamics[d*="c"]', 0.830), colors: ['#000000', '#382D00'] },
    DynamicS: { id: 97, selector: new AspectRatioSelector('.abcjs-m0.abcjs-dynamics > path, path.abcjs-m0.abcjs-dynamics[d*="c"]', 0.757), colors: ['#000000', '#E27EA3'] },
    DynamicZ: { id: 98, selector: new AspectRatioSelector('.abcjs-m0.abcjs-dynamics > path, path.abcjs-m0.abcjs-dynamics[d*="c"]', 0.980), colors: ['#000000', '#AC3B2F'] },
    ...
    DynamicCrescendoHairpin: { id: 125, selector: new HairpinSelector('path.abcjs-m0.abcjs-dynamics:not([d*="c"])', false), colors: ['#000000', '#856DE1'] },
    DynamicDiminuendoHairpin: { id: 126, selector: new HairpinSelector('path.abcjs-m0.abcjs-dynamics:not([d*="c"])', true), colors: ['#000000', '#C16E72'] },
